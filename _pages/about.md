...
profile:
  align: right
  image: Marishka-headshot-1.jpg
  image_circular: false
  more_info: >
    <p>Laureate Institute for Brain Research</p>
    <p>Tulsa, Oklahoma</p>
    <p>marishka.mehta [at] gmail.com</p>
...
More recently, my experiences using AI tools have led me to extend this interest in behavior to LLMs. Through controlled experiments, I examine how model responses change across tasks and conditions, bringing a behavioral-science perspective to questions about their capabilities and consistency. My blog, [Studying LLM Behavior]({{ '/blog/' | relative_url }}), brings together a [Getting Started series]({{ '/blog/getting-started/' | relative_url }}) for behavioral researchers and standalone experimental demonstrations exploring how LLMs reason and judge responses.
...
<p class="job-market-callout">I am on the job market for industry and academic research positions starting January 2027.</p>
